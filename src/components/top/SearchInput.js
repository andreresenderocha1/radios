...
import {fetchRadios, searchRadios, addAudio, setTab} from '../../actions/RadiosAction';
  ...
  return (
    <Paper component="form" className={classes.root}>      
        <InputBase
            ...
            onChange={(ev)=>{props.setTab('Top 100');props.searchRadios(props.radios, ev.target.value)}}
        />
